...
\includegraphics[scale=\mfig,page=4]{\pdf}%
\end{frame}

\begin{frame}
\frametitle{Caption for the graphs (one graph per click)}
\includegraphics<1>[scale=\mfig,page=1]{\pdf}%
\includegraphics<2>[scale=\mfig,page=2]{\pdf}%
\includegraphics<3>[scale=\mfig,page=3]{\pdf}%
\includegraphics<4>[scale=\mfig,page=5]{\pdf}%
\end{frame}
